...
export default function HeroHome() {
  ...
  return (
    <section className="bg-slate-50 min-h-screen pb-20" dir={t.dir}>
      ...
      {/* 1. الغلاف (Cover Photo) - تم تقليل الارتفاع في الموبايل ليتناسب مع الشاشة */}
      <div 
      ...
      {/* 2. الصورة الشخصية (Profile Box) - تم تعديل المسافات للموبايل (-mt-16) */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 -mt-16 sm:-mt-24 md:-mt-32">
        
        {/* تم تقليل البادينج (p-6) للموبايل عشان يدي مساحة للكلام */}
        <div className="bg-white rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl p-6 sm:p-8 md:p-16 text-center border-4 border-white/80">
          ...
          <div className="mb-6 md:mb-8">
            {/* تم تصغير الخط للموبايل (text-4xl) بدلا من 5xl عشان ميتأكلش */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5">
            <button
              ...
              className="w-full sm:w-auto px-8 md:px-10 py-3 md:py-4 rounded-full font-black bg-[#004b50] text-white hover:bg-[#00363a] hover:scale-105 transition-all duration-300 shadow-xl text-sm sm:text-base"
            >
              {t.btnMaintenance}
            </button>
