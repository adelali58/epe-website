export default function FloatingSocialButtons() {
  return (
    <>
      <a
        href="https://www.facebook.com/experiencego"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-24 right-6 z-50 bg-[#1877F2] text-white p-4 rounded-full shadow-[0_0_20px_rgba(24,119,242,0.4)] hover:scale-110 transition-transform flex items-center justify-center"
